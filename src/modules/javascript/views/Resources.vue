            ...
            <section class="c-box">
              ...
              <div class="u-mb-40">
                ...
                <ul>
                  ...
                  <li>
                    <a href="https://gomakethings.com/">Chris Ferdinandi</a>
                  </li>
                  <li><a href="https://laracasts.com/">Laracast</a></li>
                </ul>
              </div>
              <div class="u-mb-40">
                <h3 class="u-mb-20">Development Tools</h3>
                <ul>
